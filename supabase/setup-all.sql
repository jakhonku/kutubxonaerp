-- ============================================================
-- MAKTAB ELEKTRON KUTUBXONA — TO'LIQ O'RNATISH (BITTA BLOK)
-- Supabase Dashboard > SQL Editor da bir marta ishga tushiring.
-- Ichida: schema + web push + o'quv zali. Tartib to'g'ri berilgan.
-- Qayta ishga tushirsangiz ham xavfsiz (if not exists / drop-create).
-- ============================================================


-- ============================================================
-- 1-QISM: ASOSIY SXEMA + RLS
-- ============================================================
...
-- ============================================================
-- 3-QISM: O'QUV ZALI (reading room)
-- Kitobni soatlab, faqat zalda o'qish uchun berish.
